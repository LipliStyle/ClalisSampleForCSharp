...
{
    public partial class frmClalisEmotionXml : Form
    {
        /// <summary>
        /// コンストラクター
        /// </summary>
        #region frmClalisEmotionXml
        public frmClalisEmotionXml()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void run()
        {
            ...
            //結果の取得
            string xmlText = HttpPost.sendPost("http://liplis.mine.nu/Clalis/v30/Post/Xml/clalisEmotional.aspx", ps);
