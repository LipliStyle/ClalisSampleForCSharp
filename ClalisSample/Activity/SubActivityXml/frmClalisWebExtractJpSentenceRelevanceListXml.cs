...
{
    public partial class frmClalisWebExtractJpSentenceRelevanceListXml : Form
    {
        /// <summary>
        /// コンストラクター
        /// </summary>
        #region frmClalisWebExtractJpSentenceRelevanceList
        public frmClalisWebExtractJpSentenceRelevanceListXml()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void run()
        {
            ...
            //結果の取得
            string xmlText = HttpPost.sendPost("http://liplis.mine.nu/Clalis/v30/Post/Xml/clalisWebExtractJpSentenceRelevanceList.aspx", ps);
