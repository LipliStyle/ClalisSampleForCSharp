//=======================================================================
//  ClassName : frmClalisToneEmotion41
//  概要      : Clalis4.1 口調変換＋感情付与メソッドの使用サンプル
//
//ClalisSample
...
{
    public partial class frmClalisToneEmotion41 : frmClalisToneEmotion
    {
        #region コンストラクター
        public frmClalisToneEmotion41()
        {
            InitializeComponent();
        }
        #endregion
